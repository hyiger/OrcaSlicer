...
if (MSVC)
    ...
    if (APPLE)
        ...
        # Determine host arch from CMAKE_OSX_ARCHITECTURES (matches PrusaSlicer approach)
        if (CMAKE_OSX_ARCHITECTURES)
            set(_gmp_host_tgt ${CMAKE_OSX_ARCHITECTURES})
            if (${CMAKE_OSX_ARCHITECTURES} MATCHES "arm")
                set(_gmp_host_tgt aarch64)
                set(_gmp_ccflags "${_gmp_ccflags} -arch arm64")
            elseif (${CMAKE_OSX_ARCHITECTURES} MATCHES "x86_64")
                set(_gmp_ccflags "${_gmp_ccflags} -arch x86_64")
            endif()
            set(_cross_compile_arg --host=${_gmp_host_tgt}-apple-darwin)
        endif()
        if (IS_CROSS_COMPILE)
